...
export default function PrivacyPolicyModal({ trigger }: PrivacyPolicyModalProps) {
  ...
  const lastUpdatedDate = "December 18, 2024";
      ...
      sections: [
        {
          ...
          content: `
            This Privacy Policy describes how 清花 ("we", "our", or "us") collects, uses, and shares information about you when you use our mobile application and services.
        ...
        },
        {
          ...
          content: `
            By using 清花, you agree to these Terms of Service.
      ...
      sections: [
        {
          title: "隐私政策",
          content: `
            本隐私政策描述了清花（"我们"、"我们的"或"我们"）在您使用我们的移动应用程序和服务时如何收集、使用和共享您的信息。
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] bg-background-card border-background-primary">
        <DialogHeader className="pb-4 border-b border-background-primary">
          ...
          <p className="text-sm text-text-secondary">
            Published/Effective Date: {lastUpdatedDate}
          </p>
        </DialogHeader>
